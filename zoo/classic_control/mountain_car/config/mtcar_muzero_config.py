...
mountain_car_muzero_config = dict(
    exp_name=f'data_mtcar/mountain_car_muzero_ns{num_simulations}_upc{update_per_collect}-mur{model_update_ratio}_rr{reanalyze_ratio}_sslw2_gcv02_adam_lr3e-3_simnorm_seed0',
    env=dict(
