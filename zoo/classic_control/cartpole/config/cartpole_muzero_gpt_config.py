...
cartpole_muzero_gpt_config = dict(
    ...
    exp_name=f'data_mz_gpt_ctree_1226/cartpole_muzero_gpt_ns{num_simulations}_upc{update_per_collect}-mur{model_update_ratio}_rr{reanalyze_ratio}_H{num_unroll_steps}_nlayers2_emd64_smallnet_bs{batch_size}_mcs500_bs{batch_size}_contembdings_lsd256_obsmseloss_trans-obs-emb-init0_rep-no-avgl1norm_seed0',
