...
cartpole_muzero_gpt_config = dict(
    ...
    exp_name=f'data_mz_gpt_ctree_debug/cartpole_muzero_gpt_ns{num_simulations}_upc{update_per_collect}-mur{model_update_ratio}_rr{reanalyze_ratio}_H{num_unroll_steps}_nlayers2_emd64_smallnet_bs{batch_size}_mcs5000_batch8_obs-token-lw2_recons-obs_bs{batch_size}_lr1e-4-3e-3_tokenizer-wd0_multistep_fix-init-infer_teafor4_seed0',
